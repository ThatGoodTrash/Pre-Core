...
async def parse_response(reader: asyncio.StreamReader) -> tuple[int, bytes]:
    ...
    try:
        ...
        msg = struct.unpack("!i", msg_size)[0] - 12
        # print("a" , msg)
    ...
    try:
        while True:
            ...
            try:
                ...
                print("[-] Output too large to print. Use 'export responses' to see full output.")
...
def shell_help_message() -> None:
    ...
    print("\033[1;32mlist responses\033[0;0m - list all received responses from agent.")
        ...
        if cli_indicator == "$":
            if "export responses" in from_user:
                ...
                try:
                    ...
                    print("Successfully exported all agent responses to " + from_user.split()[2])
                except:
                    print("Export failed")
